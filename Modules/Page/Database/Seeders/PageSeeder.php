    ...
    private function records(): array
    {
        return [
            ...
            [
                ...
                'sort_order' => 1,
                'meta_description' => 'Three steps to sell or buy on Sell My Junk.',
            ...
            [
                ...
                'placement' => Page::PLACEMENT_HELP,
                'sort_order' => 2,
                'meta_description' => 'Stay safe while buying and selling on Sell My Junk.',
            ...
            [
                ...
                'sort_order' => 1,
                'meta_description' => 'Terms of service for the Sell My Junk marketplace.',
            ...
            [
                ...
                'placement' => Page::PLACEMENT_LEGAL,
                'sort_order' => 2,
                'meta_description' => 'How Sell My Junk handles your personal data.',
            ...
            [
                ...
                'placement' => Page::PLACEMENT_FOOTER,
                'sort_order' => 2,
                'meta_description' => 'Contact the Sell My Junk support team.',
                'body' => "Support\nContact us through the Sell My Junk support page and we will respond as soon as possible.\n\nTrust and safety\nReport listings and profiles directly from the report button. Urgent cases reach our moderation team first.\n\nPartnerships\nFor business enquiries, contact us through the Sell My Junk support page.",
            ],
        ];
    }
}
